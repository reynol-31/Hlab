  ...
  <body>
    ...
    <script>
      $(document).ready(function () {
        ...
        // Append content to paragraph and list with a unique item number
        $("#appendBtn").click(() => {
      ...
      // Animate element and change color
      $("#animateBtn").click(() => {
        $("#animateBox")
          .css({
            width: "100px",
...
---
## output 
![9output.png](https://raw.githubusercontent.com/reynol-31/outputs/main/9output.png)
